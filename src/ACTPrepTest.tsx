...
import { generateACTQuestions } from './actQuestions';
import { Question } from './questions';

export default function ACTPrepTest({ onBack }: { onBack: () => void }) {
  ...
  useEffect(() => {
    setQuestions(generateACTQuestions());
  }, []);
  ...
  const generateHTMLReport = (finalScore: number) => {
    ...
    const filename = `act_prep_${yy}${mm}${dd}_${hh}${mins}.html`;
...
<head>
  <meta charset="UTF-8">
  <title>Test Report - ACT Math Prep</title>
...
<body class="bg-slate-50 p-8 font-sans">
  <div class="max-w-3xl mx-auto">
    <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 text-center mb-8">
      <h1 class="text-3xl font-black text-slate-800 tracking-tight mb-2">ACT Math Prep</h1>
        ...
        <AnimatePresence mode="wait">
          {currentStep === 'welcome' && (
            ...
            >
              ...
              <h1 className="text-3xl font-bold tracking-tight mb-3">ACT Math Prep</h1>
              <p className="text-slate-600 mb-8 max-w-xl mx-auto">
                Dynamic practice test with randomized values based on the last 5 years of ACT questions.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-100">
                  <BookOpen className="w-5 h-5 text-red-500 mx-auto mb-1" />
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  ...
                  className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-xl transition-all shadow-lg"
                >
                  Start Practice Test
                </button>
                <button
            ...
            >
              <div className="sticky top-4 z-10 bg-white/80 backdrop-blur-md rounded-2xl shadow-lg p-4 flex items-center justify-between border border-white/20">
                ...
                <button
                  ...
                  className="ml-4 flex items-center gap-2 px-4 py-2 bg-red-600 text-white rounded-lg font-bold text-sm hover:bg-red-700 transition-all"
                >
              ...
              <div className="pt-8 pb-12 text-center">
                <button
                  onClick={handleSubmit}
                  className="bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-12 rounded-2xl transition-all shadow-xl"
                >
                          ...
                          {!isCorrect ? (
                            <div className="mt-4 p-4 bg-red-50/50 rounded-xl border border-red-100">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="font-bold text-red-900 text-sm">Step-by-Step Solution</span>
                              </div>
